// Package query is the board filter grammar, modelled on GitHub Projects'
// filter bar. Pure functions over internal/board — no I/O, no state. Destined
// to be folded into furrow's own -q typed query (t-z7ye); keep it thin.
package query
...
func (q Query) Match(t *board.Task, g *board.Graph) bool {
