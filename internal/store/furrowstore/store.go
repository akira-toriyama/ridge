...
// the cause: "undecodable reply: <nil>". The shape branch is defensive:
// measured on furrow dev (60074b8), both adds answer a bare row with an id
// on exit 0, and a non-zero exit never reaches this decode.
