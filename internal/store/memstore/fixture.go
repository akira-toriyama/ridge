...
func fixtureTasks() []*board.Task {
	return []*board.Task{
		...
		},
		{
			...
			// precondition row has a frame (-demo editclosed) and memstore's
			// is:overdue has a fixture case for its closed exclusion beside
			// the synthetic one (ui's isOverdue keeps only the synthetic test).
